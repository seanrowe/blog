...
class PostsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Blog.Models.Map.PostsTableMap';
     ...
     */
    const OM_CLASS = '\\Blog\\Models\\Posts';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Blog.Models.Posts';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Active', 'UserId', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'active', 'userId', ),
        self::TYPE_COLNAME       => array(PostsTableMap::COL_ID, PostsTableMap::COL_TITLE, PostsTableMap::COL_ACTIVE, PostsTableMap::COL_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'active', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Active' => 2, 'UserId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'active' => 2, 'userId' => 3, ),
        self::TYPE_COLNAME       => array(PostsTableMap::COL_ID => 0, PostsTableMap::COL_TITLE => 1, PostsTableMap::COL_ACTIVE => 2, PostsTableMap::COL_USER_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'active' => 2, 'user_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Blog\\Models\\Posts');
        $this->setPackage('Blog.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addForeignPrimaryKey('id', 'Id', 'INTEGER' , 'posts_content', 'id', true, null, null);
    ...
    {
        $this->addRelation('PostsContentRelatedById', '\\Blog\\Models\\PostsContent', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
        ...
        $this->addRelation('UsersRelatedByUserId', '\\Blog\\Models\\Users', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('PostsContentRelatedByPostsId', '\\Blog\\Models\\PostsContent', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':posts_id',
    1 => ':id',
  ),
), null, null, 'PostsContentsRelatedByPostsId', false);
        $this->addRelation('UsersRelatedById', '\\Blog\\Models\\Users', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Blog\Models\Posts) { // it's a model object
